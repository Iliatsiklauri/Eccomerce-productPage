...
const App = () => {
  ...
  return (
    ...
    >
      <div
        className={`flex flex-col items-center pb-12 relative xl:flex-row xl:justify-center xl:items-center xl:h-full xl:gap-[175px] `}
      >
        <div
          className={` items-center justify-center absolute h-full w-full bottom-0 transition-all duration-500 ease-in-outs
            ${sidebar ? 'hidden' : 'bg-black bg-opacity-90 z-30 xl:hidden'}
            `}
        ></div>
        <div
          className={`items-center justify-center absolute h-full w-full bottom-0 transition-all duration-500 ease-in-outs
          ${centerDiv ? 'hidden' : 'bg-black bg-opacity-90 z-30 xl:flex hidden'}`}
        >
        ...
        <Navbar />
        <div className="w-full max-w-[425px] xl:mt-40">
          <Gallery />
          <Thumbnail />
        </div>
        <Left />
